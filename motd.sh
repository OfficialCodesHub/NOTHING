#!/bin/bash
# Tyrkrox_gamer Advanced MOTD Installer
...
echo -e "${GREEN} Welcome to Tyrkrox_gamer Datacenter! 🚀 ${RESET}\n"
...
echo -e "${CYAN}Need help? Support is always available: https://discord.gg/2rYEHharqA${RESET}"
echo -e "${GREEN}Quality Wise — No Compromise 😄${RESET}"
EOF

chmod +x /etc/update-motd.d/00-ayushthewarrior

echo "🎉 Tyrkrox_gamer MOTD Installed Successfully!"
