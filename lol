...
# =======================================
# Rainbow banner for AyushTheWarrior
# =======================================
rainbow() {
  text=$1
...
clear
rainbow "================================================"
rainbow "    WELCOME TO AyushTheWarrior Auto Setup"
rainbow "================================================"
echo
...
================================================
  ...
  |____/ \___|_.__/|_|\__,_|_| |_|
   ...
   Debian 11 (Made By AyushTheWarrior)
================================================
BANNER
...
# =======================================
# Option 2 → create .idx/dev.nix + script.sh
# =======================================
if [ "$choice" = "2" ]; then
 echo "[INFO] Creating .idx folder and dev.nix..."
  mkdir -p "$HOME/.idx"
...
| |_| | |_) | |_| | |\  | | | | |_| |
 \___/|____/ \___/|_| \_| |_|  \___/ 
   ...
   Ubuntu 22.04 (Made By AyushTheWarrior)
================================================
BANNER
