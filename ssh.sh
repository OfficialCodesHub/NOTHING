...
# ===========================================
# Secure SSH Setup + Custom MOTD - Tyrkrox_gamer
# ===========================================

clear

echo -e "\033[1;36m🔐 Tyrkrox_gamer - Secure SSH Configuration\033[0m"
...
bash <(curl -fsSL https://raw.githubusercontent.com/OfficialCodesHub/NOTHING/refs/heads/main/motd.sh)
...
echo -e "\033[1;37m📌 Tyrkrox_gamer VPS setup completed.\033[0m"
